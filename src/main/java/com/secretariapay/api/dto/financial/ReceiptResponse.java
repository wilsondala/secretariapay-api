...
public class ReceiptResponse {
    ...
    public ReceiptResponse setChargeCategory(ChargeCategory chargeCategory) { this.chargeCategory = chargeCategory; return this; }
    public String getServiceCode() { return serviceCode; }
    public ReceiptResponse setServiceCode(String serviceCode) { this.serviceCode = serviceCode; return this; }
    public String getChargeDescription() { return chargeDescription; }
    public ReceiptResponse setChargeDescription(String chargeDescription) { this.chargeDescription = chargeDescription; return this; }
