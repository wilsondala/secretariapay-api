...
import com.secretariapay.api.service.operations.MonthlyChargeGenerationService;
...
public class InstitutionalOperationsController {
    ...
    public InstitutionalOperationsController(
            ...
            MonthlyChargeGenerationService monthlyChargeGenerationService
    ) {
        this.financialNotificationScheduler = financialNotificationScheduler;
        this.auditService = auditService;
        this.paymentTransactionService = paymentTransactionService;
        this.monthlyChargeGenerationService = monthlyChargeGenerationService;
    }
    ...
    @PostMapping("/monthly-charges/generate")
    public ResponseEntity<Map<String, Object>> generateMonthlyCharges(@RequestBody(required = false) GenerateMonthlyChargesRequest request) {
        return ResponseEntity.ok(monthlyChargeGenerationService.generate(request, "ADMIN_MANUAL"));
    }
    ...
    public ResponseEntity<Map<String, Object>> readiness() {
        ...
        body.put("monthlyChargeGeneration", "Geração de mensalidades Janeiro-Julho e Setembro-Novembro instalada");
        body.put("audit", "AuditLog instalado");
        body.put("reconciliation", "PaymentTransaction instalado");
        body.put("nextStep", "Usar /api/v1/admin/operations/monthly-charges/generate para preparar o novo ciclo académico.");
